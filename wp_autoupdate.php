...
function self_update($update, array $plugin_data, string $plugin_file, $locales)
{
    ...
    if ('pentangle-google-reviews/pentangle-google-reviews.php' !== $plugin_file) {
        return $update;
    }
    ...
    $response = wp_remote_get(
        ...
        array(
            'headers' => [
                'Authorization' => 'token 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',
